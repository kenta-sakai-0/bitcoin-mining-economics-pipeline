...
from assets.other import fx_rates
...
other_assets = load_assets_from_modules([fx_rates])
...
defs = Definitions(
    assets=[*bitcoin_assets, *mining_stocks_assets, *dbt_analytics_assets, *other_assets],
    resources={
        "gcs": gcs_resource,
        "bq": bq_resource,
        "dbt": dbt_resource
